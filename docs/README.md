...
5. [`decisions/0004-adaptation-hypothesis-demo-build.md`](decisions/0004-adaptation-hypothesis-demo-build.md) — **current decision.** Changes the claim from "it generalizes" to "adaptation costs N images," and rebuilds the preprocessing around patches. Execution in [`notes/2026-08-02-build-plan.md`](notes/2026-08-02-build-plan.md).
...
| [2026-08-02-build-plan.md](notes/2026-08-02-build-plan.md) | Execution plan for `0004` under the Monday deadline. Carries a **hard 7-hour cap** and a **cut order fixed in advance** (S10→S6, S1–S5 never cut), because `notes.md` identifies the live-coding round as the actual round and demo polish as negative-value time. §1 lists eight **code-asserted invariants** — the response to round 1's root cause being unverified preprocessing. Notes that S7 (fusion → verdict → confidence) doubles as P1 drill #1. |
